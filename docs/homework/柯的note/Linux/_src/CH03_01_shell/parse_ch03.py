...
with open('/Users/oren/Desktop/Oren_own/docs/homework/柯的note/Linux/_src/raw/F2127_Ch03.html', 'r', encoding='utf-8') as f:
    html_content = f.read()
...
# Write content.txt
with open('/Users/oren/Desktop/Oren_own/docs/homework/柯的note/Linux/_src/CH03_01_shell/content.txt', 'w', encoding='utf-8') as f:
